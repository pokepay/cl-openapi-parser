...
(defun generated-defpackage-form (package export-names)
  `(defpackage ,(make-keyword (package-name package))
     (:use :cl :alexandria)
...
(defun generate-schema.lisp (openapi-file output-stream)
  (let* ((*version* (version openapi-file))
    ...
    (let ((*print-case* :downcase)
      ...
      (pprint (generated-defpackage-form *generated-package*
                                         (nreverse *generated-class-names*))))))
